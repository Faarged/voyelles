...
-- Généré le :  Mer 03 Juillet 2019 à 14:11
...
(6, 'réservations', 'Faire l\'edit avec juste la possibilité de changer la durée'),
(7, 'Accueil', 'Faire l\'affichage des prochains a partir'),
(8, 'All résa', 'Faire une page contenant ttes les résa ds un tableau et un tableau des résa du jour qui vont partir(comme page accueil)');
...
(8, '2019-06-29', '13:00:00', '01:00:00', 'ps4'),
(9, '2019-06-29', '13:10:00', '01:00:00', 'Switch'),
(10, '2019-06-29', '13:00:00', '01:00:00', 'Switch'),
...
--
ALTER TABLE `breves`
  MODIFY `id_breves` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
...
--
ALTER TABLE `reservation`
  MODIFY `id_resa` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
--
